...
public static class ApplicationStage
{
    ...
    public static async Task Run()
    {
        ...
        var actions = new List<(string Title, Func<Task> Action, Func<bool> Condition)>
        {
            ...
            // download windhawk
            ("Downloading Windhawk", async () => await ProcessActions.RunDownload("https://www.dl.dropboxusercontent.com/scl/fi/omk2gg29v8yguskw4jhng/Windhawk.zip?rlkey=tljvtfus2tq57d3y5mzdt8ges&st=q5h496y8&dl=0", Path.GetTempPath(), "Windhawk.zip"), null),
